...
def compute_score_idk_and_answer(solution_str, ground_truth, method='strict', format_score=0.1, correct_and_confident=1, correct_and_inconfident=0.8, incorrect_and_confident=0.1, incorrect_and_inconfident=0.3):
