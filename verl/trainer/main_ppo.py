...
def _select_rm_score_fn(data_source="lighteval/MATH_idk"):
    if data_source == "openai/gsm8k":
        ...
        data_source in ["lighteval/MATH_idk", "di-zhang-fdu/MATH"]
    ):  # ? the latter seems to be happening and is a result of how the .parquet file is being created -- make sure that you built the dataset correctly!
        return math.compute_score_idk_rs
...
class RewardManager:
    ...
    # ? data = batch that is passed from `fit` in `ray_trainer`
